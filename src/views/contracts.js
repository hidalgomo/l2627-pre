            ...
            <div className="max-w-screen-2xl p-5 mb-10">
                ...
                <br />
                {
                    contractItems.map((contractItem) => (
                        <div key={ contractItem.Title } className="max-w-sm p-6 m-2 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 inline-block align-top">
                            ...
                            <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">{ contractItem.Description }</p>
                            {
                                contractItem.Links.map((link) => (
                                    <div>
                                        <Link key={ link.Name } to={ link.Href } target="_blank" className="inline-flex font-medium items-center text-blue-600 hover:underline">
                                            { link.Name }
