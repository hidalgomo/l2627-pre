                    ...
                    <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                        <div className="mb-10 w-full">
                            ...
                            <div className="mb-6 flex items-center">
                                <Link to="/" className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary text-inherit sm:mr-4 lg:mr-3 xl:mr-4">
                            ...
                            <p className="text-base text-inherit">&copy; 2025 Local2627</p>
                        </div>
                    </div>
                </div>
            </div>
